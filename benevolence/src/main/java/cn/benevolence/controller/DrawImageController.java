...
public class DrawImageController {
    ...
    public void drawImage(HttpServletRequest request, HttpServletResponse response)throws Exception{
		...
		// 将随机汉字存在session中
		ShiroUtils.setSessionAttribute(Constants.KAPTCHA_SESSION_KEY,random);
	...
	private String drawRandomNum(Graphics2D g) {
		...
		*/
		String base1 = "ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890";
		int x = 5;
		// 控制字数
		for (int i = 0; i < 4; i++) {
			// 设置字体旋转角度
			...
			// 截取汉字
			String ch = base1.charAt(new Random().nextInt(base1.length())) + "";
			sb.append(ch);
			// 正向角度
